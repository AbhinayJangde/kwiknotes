...
const App = () => {
  ...
  return (
    <>
      <h1 className='m-3 ml-5 text-white font-bold text-5xl italic'>Kwik Notes</h1>
      <div className="text-center">
        <button onClick={addNote} className='hover:bg-green-800 px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 rounded-lg'>
